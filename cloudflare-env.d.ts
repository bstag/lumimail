/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: a3e389998f6f621bce6dd77dabfa0109)
...
interface __BaseEnv_CloudflareEnv {
	...
	OUTBOUND_DLQ_QUEUE: Queue;
	PUSH_QUEUE: Queue;
	PUSH_DLQ_QUEUE: Queue;
	EXTERNAL_SYNC_QUEUE: Queue;
	EXTERNAL_SYNC_DLQ_QUEUE: Queue;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	CF_ACCOUNT_ID: "caddde404ba5d0324c315dc5cf143696";
	CF_EMAIL_WORKER_NAME: "lumimail-staging" | "lumimail";
	MAIL_PROVIDER: "cloudflare";
	PUBLIC_APP_URL: "https://lumimail-staging.blackstag.workers.dev" | "https://mail.henriksen.dev";
	PASSWORD_RESET_FROM: "noreply@STAGING_DOMAIN" | "noreply@henriksen.dev";
	WORKER_SELF_REFERENCE: Fetcher /* lumimail-staging */ | Service<typeof import("./worker").default>;
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		MAIL_PROVIDER: "cloudflare";
		PUBLIC_APP_URL: "https://lumimail-staging.blackstag.workers.dev";
		PASSWORD_RESET_FROM: "noreply@STAGING_DOMAIN";
		WORKER_SELF_REFERENCE: Fetcher /* lumimail-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "CF_EMAIL_WORKER_NAME" | "MAIL_PROVIDER" | "PUBLIC_APP_URL" | "PASSWORD_RESET_FROM" | "R2_SWEEP_ENABLED" | "SEED_ENABLED">> {}
}
