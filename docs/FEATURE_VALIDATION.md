...
| F05 claimed a dormant Tiptap/WYSIWYG authoring flow | The 2026-07-28 reconciliation first documented the plain-text reality, then restored and expanded Tiptap for MVP: semantic and safe presentation formatting, tables, uploaded CID images, sanitized HTML, derived plain text, and the server-owned reply quotation boundary are locally verified. |
