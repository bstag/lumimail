...
- Layer 2.2: read-only Cloudflare account/Worker/D1/R2/Queue/Cron/Email Routing/Sending inventories,
  required secret presence by name only, and six-check public smoke.
