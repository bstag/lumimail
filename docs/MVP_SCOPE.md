...
| F80 | Operator lifecycle and readiness doctor | In Progress | [F80](specs/F80-operator-lifecycle.md) | `scripts/doctor.mjs`, operator CLI | Local non-mutating doctor passes 15/15 across runtime, config, bindings, migrations, and operational paths. Read-only Cloudflare/secret-presence/public-smoke checks remain. Post-MVP hardening. |
