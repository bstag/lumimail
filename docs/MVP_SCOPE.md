...
| F80 | Operator lifecycle and readiness doctor | In Progress | [F80](specs/F80-operator-lifecycle.md) | `scripts/doctor.mjs`, operator CLI | Specified as a non-mutating, fail-closed local/remote readiness report; Layer 2.1 implementation is next. Post-MVP hardening. |
