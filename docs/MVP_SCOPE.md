...
| F92 | Mantle presentation layer | In Progress | [F92](specs/F92-mantle-presentation-layer.md) | brand source archive, normalized sigils, semantic theme tokens, typography, PWA assets, application shells | Stages 1–3 are staging-proven: identity, PWA assets, semantic colors, typography, and application shells. Exact-artifact production promotion remains. Behavior, data, authorization, routes, and infrastructure remain unchanged. |
