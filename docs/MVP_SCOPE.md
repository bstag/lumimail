...
| F12 | Multi-user workspace: organizations, invites, roles, mailbox access | In Progress | [F12](specs/F12-multi-user-workspace.md) | `/members`, `/api/org/members*` | Mailbox ACLs are absent; invites are not emailed and registration does not enforce the invited address. |
