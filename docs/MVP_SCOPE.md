...
| F92 | Mantle presentation layer | In Progress | [F92](specs/F92-mantle-presentation-layer.md) | brand source archive, normalized sigils, semantic theme tokens, typography, PWA assets, application shells | Stage 1 normalized identity and PWA assets are staging-proven; semantic color, typography, and shell stages remain. Behavior, data, authorization, routes, and infrastructure remain unchanged. |
