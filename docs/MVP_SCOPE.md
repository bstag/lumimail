...
| F18 | Conversation/thread view | In Progress | [F58](specs/F58-rfc-aware-conversation-grouping.md), [F59](specs/F59-html-preserving-replies.md) | `/inbox/[id]`, `/api/messages/thread/[threadId]`, compose/drafts/send queues | RFC grouping is deployed and its controlled three-message chain grouped correctly. F59's server-derived HTML-preserving reply repair is deployed as Worker `540fc496-94c5-46f0-b36f-e644ddf2390b` and awaits a repeated production chain. |
