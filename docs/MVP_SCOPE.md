...
| F92 | Mantle presentation layer | In Progress | [F92](specs/F92-mantle-presentation-layer.md) | brand source archive, normalized sigils, semantic theme tokens, typography, PWA assets, application shells | Stages 1–2 normalized identity, PWA assets, semantic colors, and typography are staging-proven; application-shell refinement and production promotion remain. Behavior, data, authorization, routes, and infrastructure remain unchanged. |
