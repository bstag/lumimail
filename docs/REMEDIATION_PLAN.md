...
- [ ] **R-09 Implement actual external forwarding or remove the claim.** Spec: [F62](./specs/F62-external-forwarding.md).
  ...
  - Remaining: production migration `0018`, deployment, verification of a real destination address by its recipient, and one controlled forwarded message received at an external mailbox.
