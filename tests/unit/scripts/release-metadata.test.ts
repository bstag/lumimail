...
function input(overrides: Record<string, unknown> = {}) {
	return {
		...
		packageManifest: { name: "email-platform", version: "0.1.0", engines: { node: ">=22" } },
		packageLock: {
			lockfileVersion: 3,
			packages: {
...
describe("deriveReleaseMetadata", () => {
	...
	it.each([
		...
		["bad Node", { nodeVersion: "20.0.0" }],
		["package mismatch", { packageManifest: { name: "email-platform", version: "0.2.0", engines: { node: ">=22" } } }],
